...
#warning zcw修改navigationitem标题颜色
    UILabel * lab = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 100, 30)];
    lab.text = @"选择图片";
    lab.textAlignment = NSTextAlignmentCenter;
    [lab setTextColor:[UIColor blackColor]];
    if (self.immediateReturn) {
        UIBarButtonItem *doneButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemCancel target:self action:@selector(cancelAction:)];
...
{
    CGFloat height = (ScreenWidth - 20)/4.0;
	return height + 4;
}
