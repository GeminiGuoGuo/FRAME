...
- (void)viewDidLoad
{
	...
	selectNum = [[UIBarButtonItem alloc] initWithTitle:@"0/10" style:UIBarButtonItemStylePlain target:nil action:nil];
	...
	selectNum.title = [NSString stringWithFormat:@"%ld/10", (unsigned long)ASSETHELPER.selectdPhotos.count];
}
